...
| Command palette (item 11) | chess | **Done.** Ctrl/Cmd+K, ranked matching with recents, disabled commands shown with their reason. Declared as a chord rather than by loosening the modifier guard added earlier. |
